...
_(none — all backlog items completed)_
...
- [x] [P1] Android mobile app (React Native / Expo) — email/password login, date inputs in search, QR code in confirmation, full booking flow — 2026-07-25
- [x] [P2] In-app messaging system — WebSocket gateway + REST API + /messages inbox + conversation thread + Navbar unread badge — 2026-07-25
- [x] [P3] Admin-configurable homepage carousel & featured section — HomepageConfig + /admin/homepage editor — 2026-07-25
- [x] [P3] Complaints & feedback page (/feedback) — FeedbackModule + /feedback public form + /admin/feedback inbox with reply/status — 2026-07-25
- [x] [P3] Build /how-it-works and /partners pages — static pages from Navbar/Footer — 2026-07-25
- [x] [P3] Driver dashboard — /driver/dashboard with schedule, active bookings, trip count — 2026-07-25
- [x] [P3] Contact Us page (/contact) — contact info + inquiry form routed to Feedback endpoint — 2026-07-25
